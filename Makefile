...
# should work fine.
	...
	(export JAVA_HOME=/usr/lib/jvm/java-11; export PATH=${JAVA_HOME}/bin:${PATH}; export SKIP_JAVADOC=0; cd java; $(MAKE) SKIP_JAVADOC=0 'JAVADOC_DEST=$(STAGING_DIR)/download/api' javadoc)
