  ...
  implements Comparable
{
   ...
   * traffic.
   **/
  public static final StreetClassification PRIM_HWY = new StreetClassification("Primary Highway", 0);

  /**
   * Classification indicating a secondary highway.  Secondary
   * highways include state highways and some county highways.
   **/
  public static final StreetClassification SEC_HWY = new StreetClassification("Secondary Highway", 1);
   ...
   **/
  public static final StreetClassification LOCAL_ROAD = new StreetClassification("Local Road", 2);
   ...
   **/
  public static final StreetClassification UNKNOWN = new StreetClassification("Unknown", 99);


  // ==================== IMPLEMENTATION ====================

  private StreetClassification(String name, int priority)
  {
    this.name = name;
