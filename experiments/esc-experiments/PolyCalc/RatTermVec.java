...
public class RatTermVec {
    ...
    public RatTermVec() { terms = new Vector(); }
     ...
     */
    public RatTerm get(int index) { return (RatTerm) terms.get(index); }
    ...
    */
    public void addElement(RatTerm t) { terms.add(t); }
    ...
    */
    public void insert(RatTerm t, int index) { terms.add(index, t); }
    ...
    */
    public void remove(int index) { terms.remove(index); }
    ...
    */
    public void set(RatTerm t, int index) { terms.setElementAt(t, index); }
    ...
    */
	...
	tv.terms = (Vector) this.terms.clone();
	return tv;
    }
