...
public class RatPolyTest extends TestCase {
	...
	assert("x^0 degree 0", rp(1,0).degree() == 0);
	assert("x^1 degree 1", rp(1,1).degree() == 1);
	assert("x^100 degree 100", rp(1,100).degree() == 100);

	assert("0*x^100 degree 0", rp(0,100).degree() == 0);

	assert("0*x^0 degree 0", rp(0,0).degree() == 0);
    }
	...
	assert(_XSqPlus2X.coeff(-1).equals(num[0]));
	assert(_XSqPlus2X.coeff(-10).equals(num[0]));
	assert(_2XSqPlusX.coeff(-1).equals(num[0]));
	assert(_2XSqPlusX.coeff(-10).equals(num[0]));
	assert(zero.coeff(-10).equals(num[0]));
	assert(zero.coeff(-1).equals(num[0]));
	...
	eq( rp(1,10).add(rp(1,5)).div
	    (rp(1,3).add(rp(1,1)).add(rp(3,0))), "x^7-x^5-3*x^4+x^3+7*x^2+8*x-10" );
    }
	...
	assert(	RatPoly.parse("NaN").isNaN() );

	assert( ! RatPoly.parse("1").isNaN() );
	assert( ! RatPoly.parse("1/2").isNaN() );
	assert( ! RatPoly.parse("x+1").isNaN() );
	assert( ! RatPoly.parse("x^2+x+1").isNaN() );
