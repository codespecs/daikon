...
public class VirtualCallReceiverSource implements DatumSpecifier, OpcodeConstants {
                ...
                switch (code[i] & 0xFF) {
                    ...
                    case OP_invokeinterface: {
                        ...
                        if (m != null && !JBCCodeUtilities.useStaticDispatch(m)) {
                            ...
                            family.addSourceDatum(i, JBCExpression.makeStackElemExpression(popCount - 1)
