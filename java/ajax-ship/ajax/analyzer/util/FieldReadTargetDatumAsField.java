...
*/
public class FieldReadTargetDatumAsField implements DatumSpecifier, OpcodeConstants {
    private void identifyQueryData(IndirectionQueryFamily family, Vector externalNodes) {
