...
public class SplitCallGraphGenerator extends Benchmark implements ResultListener, OpcodeConstants, GraphFormatter {
    ...
    protected SplitCallGraphGenerator() {
    }
    ...
    public static void main(String[] args) {
        GeneralBenchmark.run(args, new SplitCallGraphGenerator());
    }
}
