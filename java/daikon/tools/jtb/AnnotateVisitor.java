...
class AnnotateVisitor extends DepthFirstVisitor {
  ...
  public void visit(UnmodifiedClassDeclaration n) {
    ...
    if (lightweight && (Daikon.output_format != Invariant.OutputFormat.DBCJAVA)) {
    ...
    if (object_ppt == null) {
      ...
      String inv_tag = (Daikon.output_format == Invariant.OutputFormat.DBCJAVA ? "@invariant" : "invariant");
  ...
  public void visit(FieldDeclaration n) {
    ...
    if (Daikon.output_format == Invariant.OutputFormat.DBCJAVA) { return; }
  ...
  public void insertBehavior(Node n) {
	...
	if (Ast.isAccessModifier(modifier)) {
	  addComment(n, "@ " + modifier + " " + getBehaviorString() +
                     (Daikon.output_format == Invariant.OutputFormat.JML
                      ? " // Generated by Daikon"
                      : "") +
                     lineSep, true);
	...
	if (!behaviorInserted)
	  addComment(n, "@ " + "private " + getBehaviorString() +
                     (Daikon.output_format == Invariant.OutputFormat.JML
                      ? " // Generated by Daikon"
                      : "") +
                     lineSep, true);
  ...
  public void visit(MethodDeclaration n) {
    ...
    String ensures_tag = (Daikon.output_format == Invariant.OutputFormat.DBCJAVA ? "@post" : "ensures");
    String requires_tag = (Daikon.output_format == Invariant.OutputFormat.DBCJAVA ? "@pre" : "requires");
    ...
    insertModifies(n, ensures_invs.modifiedVars, ensures_tag, lightweight);
  ...
  public boolean insertModifies(Node n, String modifiesString, String prefix, boolean useJavaComment) {
    ...
    if (Daikon.output_format == Invariant.OutputFormat.JML) {
      if (pureInJML(n)) {
        doInsert = false;
      } else {
        //System.out.println("^^^CURRLINE:" + Ast.printCurrentLine(n) + "^^^");
    ...
    } else if (Daikon.output_format == Invariant.OutputFormat.DBCJAVA) {
  ...
  public boolean insertInvariants(Node n, String prefix, InvariantsAndModifiedVars invs,
	...
	String commentContents = (Daikon.output_format == Invariant.OutputFormat.DBCJAVA ? "  " : "@ ")
          + prefix + " " + inv
          + (Daikon.output_format == Invariant.OutputFormat.DBCJAVA ? "  " : ";");
	if (useJavaComment)
	  commentContents = javaLineComment(commentContents);
        else
          commentContents += lineSep;
...
//     if (!assignableInserted && (Daikon.output_format == Invariant.OutputFormat.JML)) {
//       insertAssignableEverything(n);
//     }
