...
// #if defined()
// #define EltwiseFloatNonEqual EltwiseFloatComparison
...
// #define EltwiseFloatNonEqual EltwiseIntComparison
 ...
 **/
public class EltwiseFloatNonEqual
  extends EltwiseFloatComparison
{
  ...
  protected EltwiseFloatNonEqual(PptSlice ppt) {
    super(ppt);
  }

  public static EltwiseFloatNonEqual instantiate(PptSlice ppt) {
    ...
    return new EltwiseFloatNonEqual(ppt);
  }

  protected Object clone() {
    EltwiseFloatNonEqual result = (EltwiseFloatNonEqual) super.clone();
    return result;
  }

  public String repr() {
    return "EltwiseFloatNonEqual" + varNames() + ": "
      + "falsified=" + falsified;
  }
  ...
  {
    return (other instanceof EltwiseFloatNonEqual);
  }
  ...
  public static EltwiseFloatNonEqual find(PptSlice ppt) {
    Assert.assertTrue(ppt.arity == 1);
    for (Iterator itor = ppt.invs.iterator(); itor.hasNext(); ) {
      Invariant inv = (Invariant) itor.next();
      if (inv instanceof EltwiseFloatNonEqual)
        return (EltwiseFloatNonEqual) inv;
    }
    return null;
  }
