...
// #define EltwiseIntNonEqual EltwiseFloatComparison
...
// #elif defined()
// #define EltwiseIntNonEqual EltwiseIntComparison
 ...
 **/
public class EltwiseIntNonEqual
  extends EltwiseIntComparison
{
  ...
  protected EltwiseIntNonEqual(PptSlice ppt) {
    super(ppt);
  }

  public static EltwiseIntNonEqual instantiate(PptSlice ppt) {
    ...
    return new EltwiseIntNonEqual(ppt);
  }

  protected Object clone() {
    EltwiseIntNonEqual result = (EltwiseIntNonEqual) super.clone();
    return result;
  }

  public String repr() {
    return "EltwiseIntNonEqual" + varNames() + ": "
      + "falsified=" + falsified;
  }
  ...
  {
    return (other instanceof EltwiseIntNonEqual);
  }
  ...
  public static EltwiseIntNonEqual find(PptSlice ppt) {
    Assert.assertTrue(ppt.arity == 1);
    for (Iterator itor = ppt.invs.iterator(); itor.hasNext(); ) {
      Invariant inv = (Invariant) itor.next();
      if (inv instanceof EltwiseIntNonEqual)
        return (EltwiseIntNonEqual) inv;
    }
    return null;
  }
