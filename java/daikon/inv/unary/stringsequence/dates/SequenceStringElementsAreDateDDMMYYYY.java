...
public class SequenceStringElementsAreDateDDMMYYYY extends SingleStringSequence {
  ...
  @SideEffectFree
  @Override
  public SequenceStringElementsAreDateDDMMYYYY clone(
      @GuardSatisfied SequenceStringElementsAreDateDDMMYYYY this) {
    SequenceStringElementsAreDateDDMMYYYY result =
        (SequenceStringElementsAreDateDDMMYYYY) super.clone();
   ...
   * SequenceStringElementsAreDateDDMMYYYY invariant. This code finds all of the
   * SequenceStringElementsAreDateDDMMYYYY values from each of the invariants and returns the merged
   * invariant (if any).
   *
  ...
  public @Nullable Invariant merge(List<Invariant> invs, PptSlice parent_ppt) {
    ...
    SequenceStringElementsAreDateDDMMYYYY first =
        (SequenceStringElementsAreDateDDMMYYYY) invs.get(0);
    SequenceStringElementsAreDateDDMMYYYY result = first.clone();
    ...
    for (int i = 1; i < invs.size(); i++) {
      SequenceStringElementsAreDateDDMMYYYY ssead =
          (SequenceStringElementsAreDateDDMMYYYY) invs.get(i);
