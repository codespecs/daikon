...
public class LowerBoundCore  implements java.io.Serializable {
  ...
  public double computeProbability() {
    ...
    double bound_samples_prob = prob_gt(num_min1 , required_samples_at_bound);
    ...
    // Value "c" from above
    double trunc_prob = prob_gt(num_min1 , 5*avg_samples_per_val);
    ...
    if (unif_mod_OK) {
      ...
      double unif_prob_1 = prob_gt(num_min1 , half_avg_samp);
      double unif_prob_2 = prob_gt(num_min2 , half_avg_samp);
      double unif_prob_3 = prob_gt(num_min3 , half_avg_samp);
