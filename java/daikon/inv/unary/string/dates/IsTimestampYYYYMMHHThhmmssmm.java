...
/**
 * Indicates that the value of a string variable is always a timestamp.
 * Represented as x is Timestamp. Prints as {@code YYYY-MM-DDTHH:MM:SS.mmZ (Miliseconds are
 * optional)}.
 */
