...
public final class IntLessEqual  extends TwoScalar   {
  ...
  public static IntLessEqual  instantiate(PptSlice ppt) {
    ...
    if (debugIntLessEqual  || ppt.debugged) {
      System.out.println("IntLessEqual.instantiate(" + ppt.name + ")"
                         + ", seqvar1=" + seqvar1
                         + ", seqvar2=" + seqvar2);
    }
    ...
    if (false && (seqvar1 != null) && (seqvar2 != null)) {
      ...
      if (debugIntLessEqual  || ppt.debugged) {
        System.out.println("IntLessEqual.instantiate: "
                           + "min1=" + min1
                           + ", max1=" + max1
                           + ", min2=" + min2
                           + ", max2=" + max2
  ...
  public void add_modified(long v1, long v2, int count) {
    // if (ppt.debugged) {
    //   System.out.println("IntLessEqual"  + ppt.varNames() + ".add_modified("
    //                      + v1 + "," + v2 + ", count=" + count + ")");
    // }
    if (!(v1 <=  v2)) {
      flowThis();
  ...
  public void add(long v1, long v2, int mod_index, int count) {
    if (ppt.debugged) {
      System.out.println("IntLessEqual"  + ppt.varNames() + ".add("
                         + v1 + "," + v2
                         + ", mod_index=" + mod_index + ")"
                         + ", count=" + count + ")");
    }
...
//       // IntLessEqual  instantiated at the same time?  Apparently not:  see
...
//                 && sic.enoughSamples()) {
//               // This DOES happen
//               // System.out.println("Surprise:  this can happen (var2 in IntLessEqual).");
//               // new Error().printStackTrace();
//               return true;
//             }
//           }
