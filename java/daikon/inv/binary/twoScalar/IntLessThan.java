  ...
  extends TwoScalar  
{
  ...
  public static final Category debugIntLessThan  = Category.getInstance("daikon.inv.binary.twoScalar." +
								    "IntLessThan" );
  ...
  public static IntLessThan  instantiate(PptSlice ppt) {
    ...
    if (debugIntLessThan .isDebugEnabled() || ppt.debugged) {
      debugIntLessThan .debug("IntLessThan.instantiate(" + ppt.name + ")"
			  + ", seqvar1=" + seqvar1
			  + ", seqvar2=" + seqvar2);
    }
    ...
    if (false && (seqvar1 != null) && (seqvar2 != null)) {
      ...
      if (debugIntLessThan .isDebugEnabled() || ppt.debugged) {
        debugIntLessThan .debug("IntLessThan.instantiate: "
			    + "min1=" + min1
			    + ", max1=" + max1
			    + ", min2=" + min2
			    + ", max2=" + max2
