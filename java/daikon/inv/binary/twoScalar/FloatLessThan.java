  ...
  extends TwoFloat   
{
  ...
  public static FloatLessThan  instantiate(PptSlice ppt) {
    ...
    if (debug.isDebugEnabled() || ppt.debugged) {
      debug.debug("FloatLessThan"  + ".instantiate(" + ppt.name + ")"
                          + ", seqvar1=" + seqvar1
                          + ", seqvar2=" + seqvar2);
    }
    ...
    if (false && (seqvar1 != null) && (seqvar2 != null)) {
      ...
      if (debug.isDebugEnabled() || ppt.debugged) {
        debug.debug("FloatLessThan"  + ".instantiate: "
                            + "min1=" + min1
                            + ", max1=" + max1
                            + ", min2=" + min2
                            + ", max2=" + max2
  ...
  public void add_modified(double  v1, double  v2, int count) {
    // if (ppt.debugged) {
    //   System.out.println("FloatLessThan"  + ppt.varNames() + ".add_modified("
    //                      + v1 + "," + v2 + ", count=" + count + ")");
    // }
    if (!(v1 <  v2)) {
      flowThis();
  ...
  public void add(double  v1, double  v2, int mod_index, int count) {
    if (ppt.debugged) {
      System.out.println("FloatLessThan"  + ppt.varNames() + ".add("
                         + v1 + "," + v2
                         + ", mod_index=" + mod_index + ")"
                         + ", count=" + count + ")");
    }
...
//       // FloatLessThan  instantiated at the same time?  Apparently not:  see
...
//                 && sic.enoughSamples()) {
//               // This DOES happen
//               // System.out.println("Surprise:  this can happen (var2 in " + "FloatLessThan"  + ").");
//               // new Error().printStackTrace();
//               return true;
//             }
//           }
