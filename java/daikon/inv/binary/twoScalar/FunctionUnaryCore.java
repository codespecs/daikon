  ...
  implements Serializable, Cloneable
{
 ...
 // transient public Method function;  // transient:  Method not serializable
  ...
  public FunctionUnaryCore(Invariant wrapper, String[] methodname, int methodNumber, boolean inverse) {
  ...
  //   this(wrapper, methodname, Functions.lookup(methodname), inverse);
  // }
