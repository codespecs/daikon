  ...
  extends TwoScalar  
{
  ...
  public static final Category debugIntGreaterEqual 
  ...
  public static IntGreaterEqual  instantiate(PptSlice ppt) {
  ...
  public void add_modified(long v1, long v2, int count) {
    // if (ppt.debugged) {
    //   System.out.println("IntGreaterEqual"  + ppt.varNames() + ".add_modified("
    //                      + v1 + "," + v2 + ", count=" + count + ")");
    // }
    if (!(v1 >=  v2)) {
      flowThis();
  ...
  public void add(long v1, long v2, int mod_index, int count) {
    if (ppt.debugged) {
      System.out.println("IntGreaterEqual"  + ppt.varNames() + ".add("
                         + v1 + "," + v2
                         + ", mod_index=" + mod_index + ")"
                         + ", count=" + count + ")");
    }
...
//       // IntGreaterEqual  instantiated at the same time?  Apparently not:  see
