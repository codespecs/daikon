...
public class ReadonlyPrestateFilter extends InvariantFilter {
  ...
  boolean shouldDiscardInvariant( Invariant invariant ) {
	  ...
	  if (var1.is_prestate_version(var2) && var1.var_flags.contains(VarFlags.IS_READONLY)) return true;
	  else if (var2.is_prestate_version(var1) && var2.var_flags.contains(VarFlags.IS_READONLY)) return true;
	  return false;
  }
}
