...
public class XorVisitor extends DepthFirstVisitor {
  ...
  private static boolean shouldAddInv1(final /*@Nullable*/ Invariant inv1, /*@Nullable*/ Invariant inv2) {
    return ((inv1 != null) && (inv2 == null));
  }

  /*@EnsuresNonNullIf(result=true, expression="#2")*/
  private static boolean shouldAddInv2(/*@Nullable*/ Invariant inv1, final /*@Nullable*/ Invariant inv2) {
