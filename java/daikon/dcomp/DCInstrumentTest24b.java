 ...
 */
public final class DCInstrumentTest24b {

  /** Creates a new DCInstrumentTest24b. */
  public DCInstrumentTest24b() {}
  ...
  private byte[] instrumentAsJdkClass() throws IOException {
    ...
    InputStream sampleStream =
        DCInstrumentTest24b.class.getResourceAsStream("DCInstrumentTest24b$Sample.class");
    ...
    ClassInfo classInfo = new ClassInfo(classname, DCInstrumentTest24b.class.getClassLoader());
