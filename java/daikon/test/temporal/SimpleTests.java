...
public class SimpleTests
{
    ...
    static class SampleEvent extends Event
    {
        ...
        {
            if (e instanceof TemporalTests.LetterEvent)
                {
                    TemporalTests.LetterEvent l = (TemporalTests.LetterEvent)e;
        ...
        {
            return ((e instanceof SampleEvent)
                    || (e instanceof TemporalTests.LetterEvent));
        }
    ...
    static class TestManager extends TemporalInvariantManager
    {
        TestManager()
        {
            super();
                        ...
                        for (int i = 0; i < s.name.length(); i++)
                            {
                                ...
                                out.add(TemporalTests.LetterEvent.getEvent(letterString));
                            }
                    }
