...
class StackArSplitter_isEmpty extends Splitter {

    VarInfo topOfStack_varinfo;

// Constructor: StackArSplitter_isEmpty()
// This is a constructor. But I don't know how this could be used...

    public StackArSplitter_isEmpty() {}

// Constructor: StackArSplitter_isEmpty(Ppt ppt)
...
// splitter.
    ...
    public StackArSplitter_isEmpty(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new StackArSplitter_isEmpty(ppt);
    }
