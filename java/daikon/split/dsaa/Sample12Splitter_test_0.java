...
class Sample12Splitter_test_0 extends Splitter {

	public Sample12Splitter_test_0() {
	}

	VarInfo i_varinfo;
	VarInfo size_varinfo;

	public Sample12Splitter_test_0(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample12Splitter_test_0(ppt);
	}
