...
class Sample82Splitter_printArray extends Splitter {

	public Sample82Splitter_printArray() {
	}

	VarInfo i_varinfo;
	VarInfo array_length_varinfo;

	public Sample82Splitter_printArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample82Splitter_printArray(ppt);
	}
