...
class Sample84Splitter_printArray extends Splitter {

	public Sample84Splitter_printArray() {
	}

	VarInfo i_varinfo;
	VarInfo array_length_varinfo;

	public Sample84Splitter_printArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample84Splitter_printArray(ppt);
	}
