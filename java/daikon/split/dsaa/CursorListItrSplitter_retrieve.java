...
class CursorListItrSplitter_retrieve extends Splitter {

    VarInfo current_varinfo;

// Constructor: CursorListItrSplitter_retrieve()
// This is a constructor. But I don't know how this could be used...

    public CursorListItrSplitter_retrieve() {}

// Constructor: CursorListItrSplitter_retrieve(Ppt ppt)
...
// splitter.
    ...
    public CursorListItrSplitter_retrieve(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new CursorListItrSplitter_retrieve(ppt);
    }
