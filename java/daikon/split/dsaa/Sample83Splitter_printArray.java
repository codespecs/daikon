...
class Sample83Splitter_printArray extends Splitter {

	public Sample83Splitter_printArray() {
	}

	VarInfo i_varinfo;
	VarInfo array_length_varinfo;

	public Sample83Splitter_printArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample83Splitter_printArray(ppt);
	}
