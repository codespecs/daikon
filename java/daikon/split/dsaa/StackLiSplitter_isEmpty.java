...
class StackLiSplitter_isEmpty extends Splitter {

    VarInfo topOfStack_varinfo;

// Constructor: StackLiSplitter_isEmpty()
// This is a constructor. But I don't know how this could be used...

    public StackLiSplitter_isEmpty() {}

// Constructor: StackLiSplitter_isEmpty(Ppt ppt)
...
// splitter.
    ...
    public StackLiSplitter_isEmpty(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new StackLiSplitter_isEmpty(ppt);
    }
