...
class CursorListItrSplitter_isPastEnd extends Splitter {

    VarInfo current_varinfo;

// Constructor: CursorListItrSplitter_isPastEnd()
// This is a constructor. But I don't know how this could be used...

    public CursorListItrSplitter_isPastEnd() {}

// Constructor: CursorListItrSplitter_isPastEnd(Ppt ppt)
...
// splitter.
    ...
    public CursorListItrSplitter_isPastEnd(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new CursorListItrSplitter_isPastEnd(ppt);
    }
