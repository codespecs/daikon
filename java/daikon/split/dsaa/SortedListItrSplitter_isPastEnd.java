...
class SortedListItrSplitter_isPastEnd extends Splitter {

    VarInfo current_varinfo;

// Constructor: SortedListItrSplitter_isPastEnd()
// This is a constructor. But I don't know how this could be used...

    public SortedListItrSplitter_isPastEnd() {}

// Constructor: SortedListItrSplitter_isPastEnd(Ppt ppt)
...
// splitter.
    ...
    public SortedListItrSplitter_isPastEnd(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new SortedListItrSplitter_isPastEnd(ppt);
    }
