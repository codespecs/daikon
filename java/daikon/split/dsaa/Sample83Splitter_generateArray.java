...
class Sample83Splitter_generateArray extends Splitter {

	public Sample83Splitter_generateArray() {
	}

	VarInfo i_varinfo;
	VarInfo length_varinfo;

	public Sample83Splitter_generateArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample83Splitter_generateArray(ppt);
	}
