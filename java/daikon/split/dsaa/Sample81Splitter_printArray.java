...
class Sample81Splitter_printArray extends Splitter {

	public Sample81Splitter_printArray() {
	}

	VarInfo i_varinfo;
	VarInfo array_length_varinfo;

	public Sample81Splitter_printArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample81Splitter_printArray(ppt);
	}
