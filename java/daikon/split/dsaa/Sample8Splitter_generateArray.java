...
class Sample8Splitter_generateArray extends Splitter {

	public Sample8Splitter_generateArray() {
	}

	VarInfo i_varinfo;
	VarInfo length_varinfo;

	public Sample8Splitter_generateArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample8Splitter_generateArray(ppt);
	}
