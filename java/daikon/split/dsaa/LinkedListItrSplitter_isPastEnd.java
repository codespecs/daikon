...
class LinkedListItrSplitter_isPastEnd extends Splitter {

    VarInfo current_varinfo;

// Constructor: LinkedListItrSplitter_isPastEnd()
// This is a constructor. But I don't know how this could be used...

    public LinkedListItrSplitter_isPastEnd() {}

// Constructor: LinkedListItrSplitter_isPastEnd(Ppt ppt)
...
// splitter.
    ...
    public LinkedListItrSplitter_isPastEnd(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new LinkedListItrSplitter_isPastEnd(ppt);
    }
