...
class Sample11Splitter_test_1 extends Splitter {

	public Sample11Splitter_test_1() {
	}

	VarInfo i_varinfo;
	VarInfo size_varinfo;

	public Sample11Splitter_test_1(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample11Splitter_test_1(ppt);
	}
