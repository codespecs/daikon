...
class QueueArSplitter_isFull extends Splitter {

    VarInfo theArray_length_varinfo;
    VarInfo currentSize_varinfo;

// Constructor: QueueArSplitter_isFull()
// This is a constructor. But I don't know how this could be used...

    public QueueArSplitter_isFull() {}

// Constructor: QueueArSplitter_isFull(Ppt ppt)
...
// splitter.
    ...
    public QueueArSplitter_isFull(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new QueueArSplitter_isFull(ppt);
    }
