...
class LinkedListSplitter_isEmpty extends Splitter {

    VarInfo header_next_varinfo;

// Constructor: LinkedListSplitter_isEmpty()
// This is a constructor. But I don't know how this could be used...

    public LinkedListSplitter_isEmpty() {}

// Constructor: LinkedListSplitter_isEmpty(Ppt ppt)
...
// splitter.
    ...
    public LinkedListSplitter_isEmpty(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new LinkedListSplitter_isEmpty(ppt);
    }
