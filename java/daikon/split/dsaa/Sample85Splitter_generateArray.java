...
class Sample85Splitter_generateArray extends Splitter {

	public Sample85Splitter_generateArray() {
	}

	VarInfo i_varinfo;
	VarInfo length_varinfo;

	public Sample85Splitter_generateArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample85Splitter_generateArray(ppt);
	}
