...
class OrderedListSplitter_isEmpty extends Splitter {

    VarInfo header_next_varinfo;

// Constructor: OrderedListSplitter_isEmpty()
// This is a constructor. But I don't know how this could be used...

    public OrderedListSplitter_isEmpty() {}

// Constructor: OrderedListSplitter_isEmpty(Ppt ppt)
...
// splitter.
    ...
    public OrderedListSplitter_isEmpty(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new OrderedListSplitter_isEmpty(ppt);
    }
