...
class IntegerListSplitter_find extends Splitter {

	public IntegerListSplitter_find() {
	}
	...
	public IntegerListSplitter_find(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new IntegerListSplitter_find(ppt);
	}
