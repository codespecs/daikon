...
class Sample8Splitter_printArray extends Splitter {

	public Sample8Splitter_printArray() {
	}

	VarInfo i_varinfo;
	VarInfo array_length_varinfo;

	public Sample8Splitter_printArray(Ppt ppt) {
	...
	public Splitter instantiate(Ppt ppt) {
		return new Sample8Splitter_printArray(ppt);
	}
