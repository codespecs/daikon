...
class OrderedListSplitter_insert extends Splitter {

    VarInfo ptr_next_varinfo;

// Constructor: OrderedListSplitter_insert()
// This is a constructor. But I don't know how this could be used...

    public OrderedListSplitter_insert() {}

// Constructor: OrderedListSplitter_insert(Ppt ppt)
...
// splitter.
    ...
    public OrderedListSplitter_insert(Ppt ppt) {
...
// This simply invokes the constructor.
	...
	return new OrderedListSplitter_insert(ppt);
    }
