...
class SplitterJavaSource implements jtb.JavaParserConstants {
   ...
   */
  private void writeFields(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
   ...
   */
  private void writeConstructorBody(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
    for (int i = 0; i < vars.length; i++) {
   ...
   */
  private void writeValidBody(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
    if (vars.length > 0) {
   ...
   */
  private void writeTestBody(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
   ...
   */
  private void writeReprBody(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
    add("    return " + "\""+ fileName + ": \"");
    for (int i = 0; i < vars.length; i++) {
   ...
   */
  private void writeInstantiateDummyBody(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
   ...
   */
  private void add(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this,*/ String st) {
   ...
   */
  private void skipLine(/*@Raw(SplitterJavaSource.class) SplitterJavaSource this*/) {
