...
public class Instrument implements ClassFileTransformer {
        ...
        if (Chicory.exception_handling) {
          ...
          if (catch_il != null) {
            ...
            StackMapType stackItem_type =
                new StackMapType(
                    Const.ITEM_Object,
                    pgen.addClass("java.lang.Throwable"),
            ...
            if (!mg.isStatic()) {
              ...
              localItems_types.push(
                  new StackMapType(
                      Const.ITEM_Object, pgen.addClass(mg.getClassName()), pgen.getConstantPool()));
            }
            // ADD PARAMETERS
            for (int tt = 0; tt < mg.getArgumentTypes().length; tt++) {
              ...
              localItems_types.push(
                  new StackMapType(
                      Const.ITEM_Object,
                      pgen.addClass(runType.getSignature()),
                      pgen.getConstantPool()));
            }
            ...
            if (newLocalCnt == runLocalCnt && !mg.getName().equals("<init>")) {
              ...
              new_map[stack_map_table.length] =
                  new StackMapEntry(
                      tmpTag, goalOffset, null, stackItem_types, pgen.getConstantPool());
  ...
  private /*@Nullable*/ InstructionList add_throw_instrumentation(
    ...
    if (debug) out.format("FOUND A THROW");
