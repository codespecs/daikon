...
public class ParameterDoclet implements Doclet {
  ...
  public boolean run(DocletEnvironment docEnv) {
    ...
    for (Element item : docEnv.getSpecifiedElements()) {
        ...
        new DocCategory[] {
          ...
          new DocCategory(
              ...
              new String[] {
                ...
                "They do not affect which invariants Daikon computes, only how it outputs them.",
   ...
   */
  public void processField(DocTrees docTrees, Element field) {
  ...
  public void writeTexInfo(PrintWriter out) {
    ...
    for (int c = 0; c < categories.length; c++) {
      ...
      for (
      @KeyFor("categories[c].fields") String field : MapsP.sortedKeySet(categories[c].fields)) {
  ...
  @SuppressWarnings(
      "nullness:method.invocation" // the receiver (OptionsDoclet) of printError() is initialized
  )
