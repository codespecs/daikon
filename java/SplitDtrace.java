...
public final class SplitDtrace {
  public static void main(String[] args) throws IOException {
    ...
    while (true) {
      readRec(reader, rec);
      if (rec.size()==0) break;
      if (isDeclare(rec)) declNum++;
      else
        recNum++;
    }
    reader.close();

    System.out.println("Number of DECLARE statements: "+declNum+" and number of records is: "+recNum);
  ...
  @SuppressWarnings("purity") // non-deterministic call does not affect result
