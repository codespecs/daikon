...
public class TreeFormatter extends DepthFirstVisitor {
  private List<FormatCommand> cmdQueue = new ArrayList<>();
  ...
  protected void processList(NodeListInterface n, FormatCommand cmd) {
    for (Enumeration<Node> e = n.elements(); e.hasMoreElements(); ) {
      ...
      if (cmd != null && e.hasMoreElements()) cmdQueue.add(cmd);
    }
  }
  ...
  // f0 -> ( ( "public" | "static" | "protected" | "private" | "final" | "abstract" | "synchronized"
  ...
  public void visit(FieldDeclaration n) {
    ...
    add(space());
    if (n.f2.present()) {
      for (Enumeration e = n.f2.elements();
          e.hasMoreElements();
  ...
  public void visit(ArrayInitializer n) {
    ...
    if (n.f1.present()) {
      ...
      for (Enumeration e = nlo.elements();
          e.hasMoreElements();
          processList((NodeSequence) e.nextElement(), space())) ;
    }
    if (n.f2.present()) {
  ...
  public void visit(TypeArgument n) {
    if (n.f0.which == 0) n.f0.accept(this);
    else processList((NodeSequence) n.f0.choice, space());
  }
  ...
  public void visit(NameList n) {
    n.f0.accept(this);
    if (n.f1.present()) {
      for (Enumeration e = n.f1.elements();
          e.hasMoreElements();
          processList((NodeSequence) e.nextElement(), space())) ;
    }
  }
  ...
  public void visit(UnaryExpression n) {
    if (n.f0.which == 0) processList((NodeSequence) n.f0.choice, space());
  ...
  //       | "new" ClassOrInterfaceType() [ TypeArguments() ] ( ArrayDimsAndInits() | Arguments() [
  ...
  public void visit(LocalVariableDeclaration n) {
    ...
    n.f2.accept(this);
    if (n.f3.present()) {
      for (Enumeration e = n.f3.elements();
          e.hasMoreElements();
          processList((NodeSequence) e.nextElement(), space())) ;
      {
      }
  ...
  public void visit(IfStatement n) {
    ...
    add(space());
    n.f3.accept(this);
    if (!isBlock) add(indent());
    add(force());
    n.f4.accept(this);
    if (!isBlock) add(outdent());
    if (n.f5.present()) {
  ...
  // AnnotationTypeDeclaration(modifiers) | FieldDeclaration(modifiers) )
  //       | ( ";" )
