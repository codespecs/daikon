...
public class JavaParser implements JavaParserConstants {
  ...
  public final ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(int modifiers)
  ...
  public final ClassOrInterfaceBodyDeclaration ClassOrInterfaceBodyDeclaration(boolean isInterface)
      throws ParseException {
    NodeChoice n0;
    Initializer n1;
    NodeSequence n2;
  ...
  public final AnnotationTypeDeclaration AnnotationTypeDeclaration(int modifiers)
      throws ParseException {
    NodeToken n0;
    Token n1;
    NodeToken n2;
  ...
  public final AnnotationTypeMemberDeclaration AnnotationTypeMemberDeclaration()
      throws ParseException {
    NodeChoice n0;
    NodeSequence n1;
    Modifiers n2;
  ...
  private final Token jj_consume_token(int kind) throws ParseException {
    ...
    // Throwable stack = new Throwable("PARSE FAIL lasttok: " + oldToken.image + " curtok: " +
    // token.image);
...
class JTBToolkit {
  static NodeToken makeNodeToken(Token t) {
    NodeToken node =
        new NodeToken(t.image.intern(), t.kind, t.beginLine, t.beginColumn, t.endLine, t.endColumn);

    if (t.specialToken == null) return node;

    // Modified by hand to remove rawtypes warning.  (markro)
    // Vector temp = new Vector();
    Vector<NodeToken> temp = new Vector<>();
