...
public class JavaParser implements JavaParserConstants {
  ...
  final public TypeDeclaration TypeDeclaration() throws ParseException {
   ...
   // Added by Carlos Pacheco, after observing that
   // ClassOrInterfaceDeclaration(int modifiers) doens't do anything with its parameter.
  ...
  final public EnumConstant EnumConstant() throws ParseException {
   ...
   ClassOrInterfaceBody n5;
    ...
    default:
     ...
     {if (true) return new EnumConstant(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ArrayInitializer ArrayInitializer() throws ParseException {
   ...
   // Added by Carlos Pacheco, after observing that
   // MethodDeclaration(int modifiers) doens't do anything with its parameter.
  ...
  final public FormalParameter FormalParameter() throws ParseException {
   ...
   VariableDeclaratorId n7;
    ...
    n7 = VariableDeclaratorId();
     {if (true) return new FormalParameter(n0,n3,n4,n7);}
    throw new Error("Missing return statement in function");
  }
  ...
  // CP fix to the right-bracket-closing problem.
   // If t.image == [ ">" ]+ it converts it into only one ">" and the
   // rest are converted into spaces (e.g. ">>>" becomes "> ")
   private static void fixMultipleRightBrackets(Token t) {
      ...
      StringBuffer sb = new StringBuffer(">");
         for (int i = 1 ; i < t.image.length() ; i++) {
            sb.append(' ');
         }
  ...
  final public TypeArguments TypeArguments() throws ParseException {
   ...
   Token n9;
    ...
    while (true) {
     ...
     n3.nodes.trimToSize();
    n9 = jj_consume_token(GT);
       fixMultipleRightBrackets(n9);
//    System.out.println("n9:::" + n9.image);
            n8 = JTBToolkit.makeNodeToken(n9);
  ...
  final public ForStatement ForStatement() throws ParseException {
   ...
   Statement n25;
    ...
    n24 = jj_consume_token(RPAREN);
             n23 = JTBToolkit.makeNodeToken(n24);
    n25 = Statement();
     {if (true) return new ForStatement(n0,n2,n4,n23,n25);}
    throw new Error("Missing return statement in function");
  }
