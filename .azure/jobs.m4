...
typecheck_job(ubuntu, 17, bundled)
typecheck_job(ubuntu, 21, bundled)
typecheck_job(ubuntu, 21, latest)
typecheck_job(ubuntu, 25, bundled)
typecheck_job(ubuntu, 25, latest)
