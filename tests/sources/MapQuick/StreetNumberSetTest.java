...
public class StreetNumberSetTest extends TestCase {
  ...
  public void testContainsRigorous() {
    ...
    for (int i = 1; i<=3; i+=2) {
      assertTrue("StreetNumberSet '1-3,7-1001,20221-20223' doesn't contain "+i+".",
                 sns.contains(i));
    }
  ...
  public void testContainsSingleton() {
    ...
    assertTrue("StreetNumberSet '1-3,5-505,909,2221-2223' doesn't contain 909.",
               sns.contains(909));
    assertTrue("StreetNumberSet '1-3,5-505,909,2221-2223' does contain 908.",
               !sns.contains(908));
    assertTrue("StreetNumberSet '1-3,5-505,909,2221-2223' does contain 907.",
               !sns.contains(907));
    assertTrue("StreetNumberSet '1-3,5-505,909,2221-2223' does contain 910.",
               !sns.contains(910));
    assertTrue("StreetNumberSet '1-3,5-505,909,2221-2223' does contain 911.",
               !sns.contains(911));
    assertTrue("StreetNumberSet '1-3,4-6,7,8,9,10' doesn't contain 3.",
               sns1_10.contains(3));
    assertTrue("StreetNumberSet '1-3,4-6,7,8,9,10' does contain 4.",
               !sns1_10.contains(11));
  }
  ...
  public void testContainsMixedParity() {
    ...
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 3.",
               sns.contains(3));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 4.",
               !sns.contains(4));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 5.",
               sns.contains(5));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 6.",
               sns.contains(6));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 7.",
               sns.contains(7));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 8.",
               sns.contains(8));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 9.",
               sns.contains(9));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 10.",
               sns.contains(10));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 11.",
               !sns.contains(11));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 12.",
               sns.contains(12));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 102.",
               !sns.contains(102));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500,501-503' doesn't contain 503.",
               sns2.contains(503));
  }
  ...
  public void testOrderMixedParity() {
    ...
    assertEquals("Rank of middle element in mixed parity set.",
           2, sns.orderStatistic(5));
    assertEquals("Rank of middle element in mixed parity set.",
           3, sns.orderStatistic(6));
    assertEquals("Rank of last element in mixed parity set.",
	   7, sns.orderStatistic(14));
    assertEquals("Rank of last element in mixed parity set'",
	   7, sns1.orderStatistic(10));
    assertEquals("Rank of last element in mixed parity set'",
	   6, sns2.orderStatistic(10));
  }
  ...
  public void testEquals5() {
    ...
    StreetNumberSet[] set1 = {s0_9c, s1_9b, s1_9c, s1_9d,
			      s0_9a,s1_8a, s0_8a, s0, s1_9e, s0_8c};
  ...
  public void testIntersects(){
    StreetNumberSet[] intersect = {
      sns("4-10"), sns("2-10,12-18,0"), sns("0,4,6,8,10,12,16,18"), sns("6"),
      sns("4,6-18"), sns("0,2,4,6,8"), sns("0-20")
    };
