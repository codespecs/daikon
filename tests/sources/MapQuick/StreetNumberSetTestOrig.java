...
public class StreetNumberSetTestOrig extends TestCase {
  ...
  public void testContainsMixedParity() {
    ...
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 3.",
               sns.contains(3));
    assertTrue("StreetNumberSet '1-9,6-14' does contain 4.",
               !sns.contains(4));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 5.",
               sns.contains(5));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 6.",
               sns.contains(6));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 7.",
               sns.contains(7));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 8.",
               sns.contains(8));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 9.",
               sns.contains(9));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 10.",
               sns.contains(10));
    assertTrue("StreetNumberSet '1-9,6-14' does contain 11.",
               !sns.contains(11));
    assertTrue("StreetNumberSet '1-9,6-14' doesn't contain 12.",
               sns.contains(12));
  }
