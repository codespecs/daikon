// JWN: As of the time this file was added, it was a merge of
// SNSTest.java and SNSTest2.java, with some formatting changed.  This
// was done to easily count lines of code in the test suite for the
// esc-specs paper.
...
public class StreetNumberSetTestPlus extends StreetNumberSetTest {
  ...
  public StreetNumberSetTestPlus(String name) { super(name); }
  ...
  public void testContainsRigorous() {
    ...
    for (int i = 1; i<=3; i+=2)
      assertTrue("StreetNumberSet '1-3,7-1001,20221-20223' doesn't contain "+i+".", sns.contains(i));
  ...
  public void testContainsMixedParity() {
    ...
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 3.", sns.contains(3));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 4.", !sns.contains(4));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 5.", sns.contains(5));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 6.", sns.contains(6));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 7.", sns.contains(7));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 8.", sns.contains(8));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 9.", sns.contains(9));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 10.", sns.contains(10));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 11.", !sns.contains(11));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' doesn't contain 12.", sns.contains(12));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500' does contain 102.", !sns.contains(102));
    assertTrue("StreetNumberSet '1-9,6-14,19-21,101-109,200-500,501-503' doesn't contain 503.", sns2.contains(503));
  }
  ...
  public void testHashCode() {
    ...
    assertEquals("hashCode for '1-7' is not the same as hashCode for '3-5,1,7'", s1.hashCode(), s2.hashCode());
  }
