...
public class GeoFeatureTest extends TestCase {
    ...
    /**
     * This is a helper function to make it easier to construct a GeoFeature. It takes a name and
     * two GeoPoints and creates a GeoFeature consisting of a single GeoSegment described by the
     * arguments.
     */
    ...
    /**
     * This is a helper function that makes it easier to add to a GeoFeature. It creates a
     * GeoSegment defined by the last three arguments and adds it to the end of the GeoFeature.
     */
    ...
    public void testGeoFeature() {
        ...
        if (gf.getName() != "Test") {
            fail("Name should have been set to 'Name', it was set to '" + gf.getName()
                    + "' instead.");
            ...
            assertEquals("StartHeading not set properly", gf.getStartHeading(), gs.getHeading(),
                    TOLERANCE);
            assertEquals("EndHeading not set properly", gf.getEndHeading(), gs.getHeading(),
                    TOLERANCE);
        }
    ...
    public void testGetLength() {
        ...
        assertEquals(featLoop.getLength(), s1.getLength()+s2.getLength()+s3.getLength()+s4.getLength(), TOLERANCE);
    }
    ...
    protected void checkAdd(GeoFeature gf, double length, GeoPoint end) {
        ...
        assertEquals("Length should be " + length + " but it was " + gf.getLength(), length,
                gf.getLength(), TOLERANCE);
