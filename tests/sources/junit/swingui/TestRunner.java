...
public class TestRunner extends BaseTestRunner implements TestRunContext {
    ...
    if (className != null) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(
            fFrame, "Could not create Failure DetailView - using default view");
      }
    }
  ...
  protected JLabel createLogo() {
    ...
    if (icon != null) label = new JLabel(icon);
    else label = new JLabel("JV");
  ...
  protected JFrame createUI(String suiteName) {
    ...
    addGrid(
        ...
        GridBagConstraints.HORIZONTAL,
        0.0,
        GridBagConstraints.NORTH /*CENTER*/);

    addGrid(
        panel, fStatusLine, 0, 9, 2, GridBagConstraints.HORIZONTAL, 1.0, GridBagConstraints.CENTER);
    addGrid(
        panel, fQuitButton, 2, 9, 1, GridBagConstraints.HORIZONTAL, 0.0, GridBagConstraints.CENTER);
  ...
  TestCollector createTestCollector() {
    ...
    if (className != null) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(
            fFrame, "Could not create TestCollector - using default collector");
      }
    }
