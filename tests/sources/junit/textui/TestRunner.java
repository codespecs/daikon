 ...
 * <code>suite</code> method it will be invoked and the returned test is run. Otherwise all the
 * methods starting with "test" having no arguments are run.
 *
 * <p>When the wait command line argument is given TestRunner waits until the users types RETURN.
 *
 * <p>TestRunner prints a trace as the tests are executed followed by a summary at the end.
 */
public class TestRunner extends BaseTestRunner {
  ...
  /**
   * Runs a single test and collects its results. This method can be used to start a test run from
   * your program.
   *
   * <pre>
