...
public class DirectionsFinder
{
    ...
    public void checkRep()
    {
        ...
        Assert.assertTrue(segments != null);
        ...
        while (zipIter.hasNext())
        {
            ...
            Assert.assertTrue(zip != null);
            Assert.assertTrue(zip instanceof String);

            /* CHECK: segments[zip] is non-null and is a Map. */
            Object byName = segments.get(zip);
            Assert.assertTrue(byName != null);
            Assert.assertTrue(byName instanceof Map);
            ...
            while (nameIter.hasNext())
            {
                ...
                Assert.assertTrue(!valSet.isEmpty());
                ...
                while (segIter.hasNext())
                {
                    ...
                    Assert.assertTrue(seg != null);
                    Assert.assertTrue(seg instanceof StreetSegment);
                }
            }
        }
     ...
     */
    private DirectionsFinder(Iterator ssIter, Collection zf, String dumpPrefix)
    {
	...
	this.dumpPrefix = dumpPrefix;
        ...
        // attach edges to.
        Map mapByStart = new LinkedHashMap();
        Map mapByEnd = new LinkedHashMap();
     ...
     *   to.  Otherwise, if create is true, create a new LinkedHashMap, add
