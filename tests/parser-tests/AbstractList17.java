 ...
 * @since 1.2
 */
public abstract class AbstractList17 <E > extends AbstractCollection<E>
  implements List<E>
{
  /**
  ...
  {
    return (this instanceof RandomAccess ? new RandomAccessSubList17<>(this,
...
{
  private final AbstractList17<E> l ;
