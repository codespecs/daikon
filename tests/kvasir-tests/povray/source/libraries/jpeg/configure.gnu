...
args=
for arg in $*; do
  arg=`echo $arg | sed 's,^[^-].*,,; s,-*help=[^[:space:]]*,--help,g'`
...
case "$args" in
  *help*)
  echo "Configuration of libjpeg 6b:"
  echo ""
  ;;

  *)
  echo "configure.gnu: configuring libjpeg 6b"
...
if test -f Makefile; then
  echo "configure.gnu: editing Makefile"
  sed 's,\(libjpeg.$(A)\).*,libjpeg.a,g' Makefile > Makefile.tmp
