...
#ifndef	INBUFSIZ
#  ifdef SMALL_MEM
#    define INBUFSIZ  0x100  /* input buffer size */
#  else
#    define INBUFSIZ  0x100  /* input buffer size */
#  endif
#endif
...
#ifndef	OUTBUFSIZ
#  ifdef SMALL_MEM
#    define OUTBUFSIZ   1024  /* output buffer size */
#  else
#    define OUTBUFSIZ  1024  /* output buffer size */
#  endif
#endif
...
#ifndef DIST_BUFSIZE
#  ifdef SMALL_MEM
#    define DIST_BUFSIZE 4096 /* buffer for distances, see trees.c */
#  else
#    define DIST_BUFSIZE 4096 /* buffer for distances, see trees.c */
#  endif
#endif
...
#ifndef WSIZE
#  define WSIZE 0x200     /* window size--must be a power of two, and */
