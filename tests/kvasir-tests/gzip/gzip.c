...
local int create_outfile()
{
	...
	/* Fake up ostat contents for repeatability */
	ostat.st_dev = 12;
	ostat.st_ino = 693051908;
#ifdef i386
	ostat.__st_ino = 693051908;
#endif
	ostat.st_uid = 15168;
	ostat.st_gid = 15168;
	ostat.st_blksize = 4096;
	ostat.st_atim.tv_sec = 1100028672;
	ostat.st_mtim.tv_sec = 1100028672;
	ostat.st_ctim.tv_sec = 1100028672;
    ...
    struct stat *sbuf;
{
    ...
    ret = stat(name, sbuf);
    /* Fake up sbuf contents for repeatability */
    sbuf->st_dev = 12;
    sbuf->st_ino = 693051908;
#ifdef i386
    sbuf->__st_ino = 693051908;
#endif
    sbuf->st_uid = 15168;
    sbuf->st_gid = 15168;
    sbuf->st_blksize = 4096;
    sbuf->st_atim.tv_sec = 1100028672;
    sbuf->st_mtim.tv_sec = 1100028672;
    sbuf->st_ctim.tv_sec = 1100028672;
    return ret;
}
